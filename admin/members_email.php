...
Ваш обліковий запис на сайті <<".$settings['sitename'].">> заблокував (застосував бан) адміністратор ".$userdata['user_name']." за такою підставою:\n
[REASON].\n
Якщо бажаєте отримати детальну інформацію про це блокування, будь ласка, зв`яжіться з адміністрацією сайту з допомогою електронної пошти ".$settings['siteemail'].".\n
".$settings['siteusername'];
...
Ваш обліковий запис на сайті <<".$settings['sitename'].">> заблокував адміністратор ".$userdata['user_name']." через деякі Ваші особисті дії або дії пов`язані з Вашим обліковим записом, що потенційно становили загрозу безпеці сайту.\n
Якщо бажаєте отримати детальну інформацію про це блокування з міркувань безпеки, будь ласка, зв`яжіться з адміністрацією сайту з допомогою електронної пошти ".$settings['siteemail'].".\n
".$settings['siteusername'];
$locale['email_suspend_subject'] = "Ваш обліковий запис призупинено";
$locale['email_suspend_message'] = "Вітаємо, [USER_NAME].\n
Дію Вашого облікового запису на сайті <<".$settings['sitename'].">> призупинив адміністратор ".$userdata['user_name']." до [DATE] (час на сайті) за наступною підставою:\n
[REASON].\n
Якщо бажаєте отримати детальну інформацію про це призупинення, будь ласка, зв`яжіться з адміністрацією сайту з допомогою електронної пошти ".$settings['siteemail'].".\n
".$settings['siteusername'];
?>